...
const CreatePart3: React.FC<CrPartProps> = ({ updateExamData }) => {
  ...
  const [part3Data, setPart3Data] = useState<groupQuestionData[]>(
    Array.from({ length: TOEIC_PARTS.Part3.groupQuestion }, (_) => ({
              ...
              <Stack>
                <Box display="flex" flexDirection="column" alignItems="center">
                  ...
                  {part3Data[group].audioUrl && (
                    ...
                    >
                      <source
                        src={part3Data[group].audioPreview}
                        type={part3Data[group].audioUrl}
                      />
                    </audio>
                  )}
